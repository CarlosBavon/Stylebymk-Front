  ...
  return (
    <div className="about-page">
      <div className="about-hero">
        <h1 className="about-title fade-up">About <span className="gold-text">STYLEBYMK</span></h1>
      </div>
      ...
      <div className="about-story">
        ...
        <p>At STYLEBYMK, I believe that hair is more than just strands - it's a statement of personality. Our commitment to excellence and attention to detail has made us one of the most sought-after hairstyling destinations.</p>
      </div>
    </div>
  );
};
